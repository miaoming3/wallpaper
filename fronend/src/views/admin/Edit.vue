...
onMounted( ()=>{
    if(id){
      getAdminById(id.value).then((res)=>{
        Object.assign(localAdminInfo,res.data)
  ...
  <div id="admin-info">
    ...
    <el-form :model="localAdminInfo" label-width="120px" class="info-form" size="large" ref="formRef" :rules="rules">
      ...
      <el-form-item label="密码" prop="password">
        <el-input v-model="localAdminInfo.password" show-password />
      </el-form-item>
      ...
      <el-form-item label="状态">
        <el-select v-model="localAdminInfo.status">
          <el-option
